        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <Card className="p-6">
            ...
            <div className="space-y-4">
              {["New purchase request from Marketing", "Payroll processed for 25 employees", "3 invoices due this week"].map((activity, i) => <div key={i} className="flex items-center gap-4 text-sm text-muted-foreground">
